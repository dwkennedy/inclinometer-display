/*
  ...
  now modified for landscape orientation
...
#define LEVEL_X_CENTER (HEIGHT/2)
#define LEVEL_Y_CENTER (HEIGHT/2)
// rings
...
#define LEVEL_SCALE (HEIGHT/(2*LEVEL_RANGE))
...
void setup() {
  ...
  myGLCD.print("NSSL/FOFS",CENTER,40);
  myGLCD.print("Inclinometer",CENTER,140);
  myGLCD.print("Display, v2.0",CENTER,240);
  myGLCD.print("http://github/dwkennedy", CENTER, 340);
  
  // initialize digital pin LED_BUILTIN as an output.
  pinMode(LED_BUILTIN, OUTPUT);

  Serial1.println("NSSL Inclinometer Display v2.0");
  Serial1.println("https://github.com/dwkennedy/inclinometer-display");
  Serial1.println("");
...
void updateDisplay() {
  ...
  myGLCD.print(outputString1, RIGHT, 20);
  myGLCD.print(outputString2, RIGHT, 100);
  ...
  // crosshairs
  myGLCD.drawLine(LEVEL_X_CENTER, LEVEL_Y_CENTER-HEIGHT/2, LEVEL_X_CENTER, LEVEL_Y_CENTER+HEIGHT/2);
  myGLCD.drawLine(LEVEL_X_CENTER-HEIGHT/2, LEVEL_Y_CENTER, LEVEL_X_CENTER+HEIGHT/2, LEVEL_Y_CENTER);

  // draw or erase TIMEOUT message
  if (timeoutFlag) {
    myGLCD.setColor(255,0,0);
//    myGLCD.print("NOT UPDATING",CENTER, 200);
    myGLCD.print("NOT   ", RIGHT, 320);
    myGLCD.print("UPDATING!", RIGHT, 400);
  } else {
    // erase NOT UPDATING message
    myGLCD.setColor(0,0,0);
//    myGLCD.fillRect(0,180,WIDTH,264);
    myGLCD.fillRect(WIDTH-290, 320, WIDTH, 480);
  }
